...
ProcessPedidoZip(pedidoDir, id, zipPath) {
    ...
    try {
        ...
        ; ===== FLUXO DOS PIPELINES =====
        if (tipoSafe = "resultado" || tipoSafe = "escalacao" || tipoSafe = "contratacao" || tipoSafe = "proximo_jogo" || tipoSafe = "patrocinador" || tipoSafe = "escudo3d" || tipoSafe = "proximo_jogo_jogador" || tipoSafe = "resultado_jogo_jogador" || tipoSafe = "jogador_escudo" || tipoSafe = "mascote_uniforme") {
...
NormalizeTipo(t) {
    ...
    ; tipos novos do site
    if (t = "escalacao" || t = "contratacao" || t = "proximo_jogo" || t = "patrocinador" || t = "escudo3d" || t = "proximo_jogo_jogador" || t = "resultado_jogo_jogador" || t = "jogador_escudo" || t = "mascote_uniforme")
        return t
