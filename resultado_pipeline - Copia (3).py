...
def main():
    ...
    if moldura_src:
        tint_template(moldura_src, moldura_t, cor_secundaria, strength=1.0)
    if topo_src:
        tint_template(topo_src, topo_t, cor_secundaria, strength=1.0)
    if faixa1_src:
        tint_template(faixa1_src, faixa1_t, cor_primaria, strength=1.0)
    if faixa2_src:
        tint_template(faixa2_src, faixa2_t, cor_secundaria, strength=1.0)
