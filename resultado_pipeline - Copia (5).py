...
def build_text_lines(pedido: dict) -> list[str]:
    ...
    if categoria == "resultado":
        ...
        add_line(lines, titulo_pedido or "PRÓXIMO JOGO")
        add_line(lines, "ARTE COM FOCO NO JOGADOR")
        ...
        add_line(lines, titulo_pedido or "RESULTADO FINAL")
        add_line(lines, "DESTAQUE DO JOGADOR")
        add_line(lines, build_score_text(pedido))
        add_line(lines, rodada)
        add_line(lines, data)
        add_line(lines, hora)
        ...
        add_line(lines, titulo_pedido or "JOGADOR")
        add_line(lines, data)
        add_line(lines, rodada)
        ...
        add_line(lines, "ESCUDO 3D")

    else:
        add_line(lines, titulo_pedido or "ARTE")
        add_line(lines, rodada)
        add_line(lines, data)
...
def main():
    ...
    prompt = f"{prompt_base}\n\nDADOS DO PEDIDO (USAR EXATAMENTE):\n{texto_formatado}"
